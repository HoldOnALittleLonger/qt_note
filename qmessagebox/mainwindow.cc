...
void MainWindow::setupSignalsAndSlots()
{
  ...
  connect(newPushButton, SIGNAL(clicked()), this, SLOT(clearAllRecords()));
}
...
void MainWindow::saveButtonClicked()
{
  ...
  QMessageBox::information(this, tr("RMS Ssystem"), tr("Record saved successfully!"),
...
void MainWindow::clearFields()
{
 ...
 {
   QMessageBox::about(this, "About RMS System", "RMS System 2.0" "<p>Copyright &copy; 2005 Inc."
